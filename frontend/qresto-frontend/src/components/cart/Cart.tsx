...
const Cart = () => {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener(QRESTO_OPEN_CART_EVENT, openFromEvent);
  }, []);
            ...
            <div className="flex-1 overflow-y-auto">
              {isLoading ? (
                ...
                <div className="flex h-full flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-lg font-bold">Sepetiniz boş</h3>
                    ...
                    >
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        ...
                        <span className="text-lg font-bold text-[var(--qresto-primary)]">
                          {formatPrice(
                            item.lineTotal ?? item.productPrice * item.quantity
                          )}
                        </span>
                      </div>
                    </div>
            ...
            <div className="mt-6 border-t border-[var(--qresto-border)] pt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  disabled={!cartId || cartItems.length === 0 || isOrdering}

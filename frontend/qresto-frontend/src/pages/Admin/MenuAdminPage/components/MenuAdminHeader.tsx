    ...
    return (
        <header className="menu-admin-header flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <button
                ...
                className="bg-primary-container text-on-primary h-10 px-4 rounded-lg font-label-bold hover:opacity-90 transition-opacity shrink-0 flex items-center gap-1 self-start sm:self-auto"
            >
